    ...
    <Layout>
      ...
      <SurveyHeadSection>
        <HeaderContainer maxWidth='lg'>
          <SurveyHeadSelectionWrapper>
            <TabButton active={true}>
              ...
              <div>
                <Typography variant='button' sx={{ textTransform: 'initial', fontSize: '16px' }}>
                  Questions
                </Typography>
              </div>
            </TabButton>
        ...
        <Container maxWidth='lg' sx={{ marginTop: '30px' }}>
          ...
          <TextField id='outlined-basic' placeholder='Enter your welcome text here' fullWidth variant='outlined' />
        </Container>
      </SurveyHeadSection>
    </Layout>
  )
